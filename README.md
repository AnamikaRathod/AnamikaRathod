...
<p align="left" dir="auto">
  <ul>
    <li>
      <p>👩‍🎓 I'm Anamika Rathod, a <strong>BCA Third Semester </strong> Student.</p>
    </li>
    <li>
      <p>🔭 I’m looking to contribute to <strong>open-source projects.</strong></p>
    </li>
    <li>
      <p>🌱 I am interested in programming, especially in <strong>Java, C++, Python and DBMS.</strong></p>
    </li>
    <li>
